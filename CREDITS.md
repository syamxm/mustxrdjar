...
All faces are self-hosted from `public/fonts/` as latin-subset `.woff2`, downloaded from Google Fonts. Full licence texts are in `licenses/`.
...
All artwork in `art/` is by mustxrdjar and is not covered by the licences above. All rights reserved.
